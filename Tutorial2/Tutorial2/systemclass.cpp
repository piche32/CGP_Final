...
bool SystemClass::Frame() {
	...
	if (m_Input->IsKeyDown('1')) {
		if (!(m_Graphics->getTextureShader()->SetSamplingFilter(1, m_Graphics->getD3D()->GetDevice()))) {
			return false;
		}
	}
	else if (m_Input->IsKeyDown('2')) {
		if (!(m_Graphics->getTextureShader()->SetSamplingFilter(2, m_Graphics->getD3D()->GetDevice()))) {
			return false;
		}
	}
	else if (m_Input->IsKeyDown('3')) {
		if (!(m_Graphics->getTextureShader()->SetSamplingFilter(3, m_Graphics->getD3D()->GetDevice()))) {
			return false;
		}
	}
