...
bool LightShaderClass::Initialize(ID3D11Device* device, HWND hwnd) {
	...
	result = InitializeShader(device, hwnd, (WCHAR*)L"../Tutorial2/light.vs",
		(WCHAR*)L"../Tutorial2/light.ps");
...
bool LightShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXMATRIX worldMatrix,
	...
	result = SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix,
		texture, lightDirection, ambientColor, diffuseColor, cameraPosition,
...
bool LightShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename,
	WCHAR* psFilename) {
	HRESULT result;
...
//HW2 - 4
/*bool LightShaderClass::SetSamplingFilter(const int input, ID3D11Device* device) {
	D3D11_SAMPLER_DESC samplerDesc;
	if (input == 1) {
