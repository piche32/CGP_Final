...
bool FontShaderClass::Initialize(ID3D11Device* device, HWND hwnd) {
	...
	result = InitializeShader(device, hwnd, (WCHAR*)L"../Tutorial2/font.vs",
		(WCHAR*)L"../Tutorial2/font.ps");  //error시 확인
...
bool FontShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXMATRIX worldMatrix,
	...
	result = SetShaderParameters(deviceContext, worldMatrix, viewMatrix, 
		projectionMatrix, texture, pixelColor);
	if (!result) { return false; }
...
void FontShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd,
